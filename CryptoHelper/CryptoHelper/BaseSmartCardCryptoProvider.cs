...
{
    /// <summary>
    /// This class is responsible for fetching certificates from smart card.
    ...
    public static class BaseSmartCardCryptoProvider
    {
        ...
        /// <summary>
        /// Get list of certificates of the currently connected smart card.
        /// </summary>
        /// <returns>List of certificates of the connected smart car.d</returns>
        /// <exception cref="CryptographicException">The cryptographic service provider (CSP) cannot be acquired.</exception>
        /// <exception cref="Win32Exception">There has been an error in accessing the card certificate container</exception>
        ...
        /// <summary>
        /// Gets the smart card key container.
        /// </summary>
        /// <returns>List of smart card containers.</returns>
        /// <exception cref="Win32Exception">There has been an error in accessing the card certificate container</exception>
